...
public class VideoReportSpecification implements Specification<VideoReport> {
    private final SearchCriteria criteria;
    private static final DateTimeFormatter DATE_TIME_FORMATTER = DateTimeFormatter.ISO_LOCAL_DATE_TIME;

    public VideoReportSpecification(SearchCriteria criteria) {
    ...
    private Predicate buildComparisonPredicate(Root<VideoReport> root, CriteriaBuilder builder, String key, Object value, boolean isGreaterThan) {
        return buildComparisonPredicate(root, builder, key, value, isGreaterThan, false);
    }

    private Predicate buildComparisonPredicate(Root<VideoReport> root, CriteriaBuilder builder, String key, Object value, boolean isGreaterThan, boolean includeEqual) {
